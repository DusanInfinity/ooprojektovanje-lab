...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        btn_BrisanjeCifre->setFont(font1);
        ...
        btn_FUNC2020 = new QPushButton(Widget);
        btn_FUNC2020->setObjectName(QStringLiteral("btn_FUNC2020"));
        btn_FUNC2020->setFont(font1);

        gridLayout_3->addWidget(btn_FUNC2020, 4, 0, 1, 5);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        btn_FUNC2020->setText(QApplication::translate("Widget", "FUNC2020", Q_NULLPTR));
    } // retranslateUi
